			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						<li><a href="registration.php"><i class="fa fa-user-plus"></i> Registration</a></li>
						<?php	
					}
					?>

					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> View Cart (₹<?php
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="search_text" name="search_text">
					</div>
